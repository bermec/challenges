'''
Your dog just won X place in a dog show, congratulations! You post your star's photo
and placement announcement to /r/aww and, predictably, a funny redditor asks what
places the rest of the participating dogs took. Your job is to create a program that
lists all places within the range of 0-100 in spoken English, excluding the placing
(X) of your winning pup.
Input description
...
0th, 2nd, 3rd, 4th, 5th, 6th, 7th, 8th, 9th, 10th, 11st, 12nd, 13rd, 14th, 15th,
...
for position in range(2, 102):
    ...
    print(str(temp) + get_position(position))