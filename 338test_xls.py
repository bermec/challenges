...
for key in day_of_week.keys():
    if day_of_week[key] == targetval:
        ...
        break
this_day_number = key
print('this_day: ', this_day_number)
...
candidate_day_of_week = (day_accumulator + this_day_number - 1) % 7
