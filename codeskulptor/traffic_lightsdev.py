...
def draw(canvas):
    ...
    canvas.draw_circle((400,100), 25, 2, 'Red', 'Red')
    canvas.draw_polygon([(380, 120),(420, 120),(430, 230),(390,230)], 2, 'Red', 'Red')
    canvas.draw_polygon([(420, 230),(390, 230),(330, 330),(360,340)], 2, 'Red', 'Red')
    canvas.draw_polygon([(430, 230),(400, 230),(440, 360),(470,350)], 2, 'Red', 'Red')
    canvas.draw_polygon([(420, 120),(400, 120),(470, 230)], 2, 'Red', 'Red')
    canvas.draw_polygon([(380, 120),(420, 120),(320, 230)], 2, 'Red', 'Red')
    canvas.draw_polygon([(340, 330),(340, 315),(305, 320)], 2, 'Red', 'Red')
    canvas.draw_polygon([(450, 355),(450, 335),(415, 365)], 2, 'Red', 'Red')
