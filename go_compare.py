...
for candidate_date in dates:
    ...
    if candidate_month == month_now and (candidate_yr == yr_now):
        ...
        candidate_month, yr_now)
        days_used_this_month = day_now - 1

        if flag:
            day_accumulator += future_cand_days_in_month + future_days_in_month_now\
            + future_months_between_dates
        else:
            day_accumulator += months_between_dates + candidate_days_left_of_month\
        ...
        if flag:
            ...
            + days_in_months_elapsed + months_this_year
        ...
        if flag:
            day_accumulator += future_years_elapsed + future_days_in_month_now + \
                               future_cand_days_in_month + future_months_to_go +\
                               future_cand_months
        else:
            day_accumulator += candidate_days_left_of_month + days_used_this_month \
